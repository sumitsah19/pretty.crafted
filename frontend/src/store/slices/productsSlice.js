...
const DEMO_PRODUCTS = [
  { id:1,  name:"Wildflower Soy Candle",      category:"Candles & Scents",   price:28, originalPrice:35, recipient:"her",  emoji:"🕯️", bg:"#E8D5C4", tag:"Bestseller", handcrafted:true,  rating:4.9, ratingCount:247, stock:47, description:"Hand-poured with wildflower botanical extracts and a clean cotton wick." },
  { id:2,  name:"Pressed Botanicals Ring",     category:"Handmade Jewelry",   price:42, originalPrice:52, recipient:"her",  emoji:"💍", bg:"#D5E0CC", tag:"New",        handcrafted:true,  rating:4.8, ratingCount:183, stock:12, description:"Preserved real botanicals set in clear resin on a sterling-silver band." },
  { id:3,  name:"Stoneware Coffee Mug",        category:"Ceramics",           price:28, originalPrice:34, recipient:"him",  emoji:"☕", bg:"#D4C5B5", tag:"Bestseller", handcrafted:true,  rating:4.7, ratingCount:312, stock:34, description:"Wheel-thrown stoneware with a warm glaze and generous 350ml capacity." },
  { id:4,  name:"Linen Watercolor Print",      category:"Art Prints",         price:48, originalPrice:60, recipient:"her",  emoji:"🖼️", bg:"#E0D5C5", tag:"",          handcrafted:true,  rating:4.6, ratingCount:89,  stock:8,  description:"Original watercolor reproduced on 300gsm cotton-linen paper." },
  { id:5,  name:"Rose Clay Face Mask Set",     category:"Skincare",           price:22, originalPrice:29, recipient:"her",  emoji:"🌹", bg:"#E8D0C8", tag:"New",        handcrafted:true,  rating:4.8, ratingCount:205, stock:56, description:"Three masks with rose clay, kaolin and chamomile for sensitive skin." },
  { id:6,  name:"Leather-bound Journal",       category:"Books & Stationery", price:38, originalPrice:45, recipient:"him",  emoji:"📔", bg:"#C8B89A", tag:"",          handcrafted:true,  rating:4.7, ratingCount:156, stock:21, description:"Full-grain leather cover with 200 pages of 120gsm cream dot-grid paper." },
  { id:7,  name:"Wildberry Jam Set",           category:"Food & Gourmet",     price:32, originalPrice:40, recipient:"kids", emoji:"🫙", bg:"#D4C0D0", tag:"Bestseller", handcrafted:false, rating:4.9, ratingCount:134, stock:39, description:"Three artisan jams: blackberry, raspberry, and wild blueberry preserve." },
  { id:8,  name:"Mini Terrarium Kit",          category:"Plants",             price:45, originalPrice:56, recipient:"kids", emoji:"🌱", bg:"#C8D8C0", tag:"New",        handcrafted:false, rating:4.6, ratingCount:78,  stock:15, description:"Everything you need to build a tiny ecosystem: pebbles, moss, soil, succulents." },
  { id:9,  name:"Cedar Beard Oil",             category:"Skincare",           price:26, originalPrice:32, recipient:"him",  emoji:"🌲", bg:"#C4D0C0", tag:"",          handcrafted:true,  rating:4.7, ratingCount:93,  stock:28, description:"Jojoba, argan and cedar essential oil blend for a soft, healthy beard." },
...
const DEMO_HAMPERS = [
  { id:13, name:"Radiant Morning Hamper", category:"Hampers", price:1499, originalPrice:1899, recipient:"her", emoji:"🧺", bg:"#EDD5C0", tag:"Bestseller", rating:4.5, ratingCount:76,  stock:30, description:"Soy candle, rose clay mask, linen print & more." },
